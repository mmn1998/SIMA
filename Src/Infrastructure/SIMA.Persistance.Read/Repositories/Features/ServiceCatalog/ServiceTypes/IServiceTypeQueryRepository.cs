...
{
    Task<GetServiceTypeQueryResult> GetById(GetServiceTypeQuery request);
    Task<Result<IEnumerable<GetServiceTypeQueryResult>>> GetAll(GetAllServiceTypesQuery request);
}