...
INNER JOIN [AssetAndConfiguration].[DataProcedureInputParam] DPIPP on DPIP.ParentId = DPIP.Id and DPIPP.ActiveStatusId<>3
where DP.Id = @Id
...
INNER JOIN [AssetAndConfiguration].DataProcedureOutputParam DPIPP on DPIP.ParentId = DPIP.Id and DPIPP.ActiveStatusId<>3
where DP.Id = @Id
