...
public class SupervisorAnswerTypeConfiguration : IEntityTypeConfiguration<SupervisorAnswerType>
{
    public void Configure(EntityTypeBuilder<SupervisorAnswerType> entity)
    {
        entity.ToTable("SupervisorAnswerType", "SecurityCommitee");
