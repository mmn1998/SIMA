...
public class SeverityValueConfiguration : IEntityTypeConfiguration<SeverityValue>
{
    public void Configure(EntityTypeBuilder<SeverityValue> entity)
    {
        entity.ToTable("SeverityValue", "RiskManagement");
