...
public class ConsequenceLevelConfiguration : IEntityTypeConfiguration<ConsequenceLevel>
{
    public void Configure(EntityTypeBuilder<ConsequenceLevel> entity)
    {
        entity.ToTable("ConsequenceLevel", "RiskManagement");
