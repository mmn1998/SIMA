...
public class AffectedHistoryConfiguration : IEntityTypeConfiguration<AffectedHistory>
{
    public void Configure(EntityTypeBuilder<AffectedHistory> entity)
    {
        entity.ToTable("AffectedHistory", "RiskManagement");
