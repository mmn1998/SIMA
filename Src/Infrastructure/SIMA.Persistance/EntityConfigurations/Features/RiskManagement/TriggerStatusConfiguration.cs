...
public class TriggerStatusConfiguration : IEntityTypeConfiguration<TriggerStatus>
{
    public void Configure(EntityTypeBuilder<TriggerStatus> entity)
    {
        entity.ToTable("TriggerStatus", "RiskManagement");
