...
public class CriticalActivityExecutionPlanConfiguration : IEntityTypeConfiguration<CriticalActivityExecutionPlan>
{
    public void Configure(EntityTypeBuilder<CriticalActivityExecutionPlan> entity)
    {
        ...
        entity.HasOne(x => x.CriticalActivity)
            .WithMany(x => x.CriticalActivityExecutionPlans)
