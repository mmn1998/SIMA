...
public class RequestValorConfiguration : IEntityTypeConfiguration<RequestValor>
{
    public void Configure(EntityTypeBuilder<RequestValor> entity)
    {
        entity.ToTable("RequestValor", "TrustyDraft");
