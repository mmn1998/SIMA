...
public class ReconsilationTypeConfiguration : IEntityTypeConfiguration<ReconsilationType>
{
    public void Configure(EntityTypeBuilder<ReconsilationType> entity)
    {
        entity.ToTable("ReconsilationType", "TrustyDraft");


        entity.Property(x => x.Id)
            .HasConversion(
             v => v.Value,
             v => new ReconsilationTypeId(v)).ValueGeneratedNever();
