...
public class DraftStatusConfiguration : IEntityTypeConfiguration<DraftStatus>
{
    public void Configure(EntityTypeBuilder<DraftStatus> entity)
    {
        entity.ToTable("DraftStatus", "TrustyDraft");
