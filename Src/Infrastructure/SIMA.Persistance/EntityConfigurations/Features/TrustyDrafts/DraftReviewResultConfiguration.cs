...
public class DraftReviewResultConfiguration : IEntityTypeConfiguration<DraftReviewResult>
{
    public void Configure(EntityTypeBuilder<DraftReviewResult> entity)
    {
        entity.ToTable("DraftReviewResult", "TrustyDraft");
