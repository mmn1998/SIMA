...
public class DraftOriginConfiguration : IEntityTypeConfiguration<DraftOrigin>
{
    public void Configure(EntityTypeBuilder<DraftOrigin> entity)
    {
        entity.ToTable("DraftOrigin", "TrustyDraft");


        entity.Property(x => x.Id)
            .HasConversion(
             v => v.Value,
             v => new DraftOriginId(v)).ValueGeneratedNever();
