...
namespace SIMA.Persistance.Migrations
{
    ...
    [Migration("20240526124124_ChangetypeConfirmcode")]
    partial class ChangetypeConfirmcode
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SIMA.Domain.Models.Features.BCP.BusinessContinuityPlans.Entities.BusinessContinuityPlanService", b =>
                {
                    ...
                    b.ToTable("BCP", "BusinessContinuityPlanService");
                });
            ...
            modelBuilder.Entity("SIMA.Domain.Models.Features.BCP.BusinessContinuityPlans.Entities.BusinessContinuityPlanStaff", b =>
                {
                    ...
                    b.ToTable("BCP", "BusinessContinuityPlanStaff");
                });
            ...
            modelBuilder.Entity("SIMA.Domain.Models.Features.RiskManagement.Risks.Entities.GeneralControlAction", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("GeneralControlAction", "RiskManagement");
                });

            modelBuilder.Entity("SIMA.Domain.Models.Features.RiskManagement.Risks.Entities.NextPossibleAction", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("NextPossibleAction", "RiskManagement");
                });
            ...
            modelBuilder.Entity("SIMA.Domain.Models.Features.RiskManagement.Risks.Entities.GeneralControlAction", b =>
                {
                    b.HasOne("SIMA.Domain.Models.Features.RiskManagement.Risks.Entities.Risk", "Risk")
                        .WithMany("GeneralControlActions")
                        .HasForeignKey("RiskId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_GeneralControlAction_Risk");
            ...
            modelBuilder.Entity("SIMA.Domain.Models.Features.RiskManagement.Risks.Entities.NextPossibleAction", b =>
                {
                    b.HasOne("SIMA.Domain.Models.Features.RiskManagement.Risks.Entities.Risk", "Risk")
                        .WithMany("NextPossibleActions")
                        .HasForeignKey("RiskId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_NextPossibleAction_Risk");
            ...
            modelBuilder.Entity("SIMA.Domain.Models.Features.RiskManagement.Risks.Entities.Risk", b =>
                {
                    b.HasOne("SIMA.Domain.Models.Features.RiskManagement.RiskImpacts.Entities.RiskImpact", "RiskImpact")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_Risk_RiskImpact");
                    ...
                    b.HasOne("SIMA.Domain.Models.Features.RiskManagement.RiskPossibillities.Entities.RiskPossibility", "RiskPossibility")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_Risk_RiskPossibility");
            ...
            modelBuilder.Entity("SIMA.Domain.Models.Features.RiskManagement.Risks.Entities.Risk", b =>
                {
                    ...
                    b.Navigation("GeneralControlActions");

                    b.Navigation("NextPossibleActions");
