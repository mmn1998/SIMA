...
namespace SIMA.Persistance.Migrations
{
    ...
    [Migration("20241120063920_trustyChanges20241119")]
    partial class trustyChanges20241119
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SIMA.Domain.Models.Features.TrustyDrafts.DraftOrigins.Entities.CancellationResaon", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("SIMA.Domain.Models.Features.TrustyDrafts.DraftOrigins.Entities.ResponsibilityWageType", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("SIMA.Domain.Models.Features.TrustyDrafts.Reconsilations.Entities.Reconsilation", b =>
                {
                    ...
                    b.Property<decimal>("DraftAmountBaseCurrency")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<decimal>("NetAmountBaseCurrency")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<string>("SwiftMessageCode")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<decimal>("TaxAmountBaseCurrency")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<decimal>("WageAmountBaseCurrency")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("SIMA.Domain.Models.Features.TrustyDrafts.TrustyDrafts.Entities.PaymentReceiptInfo", b =>
                {
                    ...
                    b.Property<long>("BeneficiaryAccountTypeId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("BeneficiaryAccountTypeId");
            ...
            modelBuilder.Entity("SIMA.Domain.Models.Features.TrustyDrafts.TrustyDrafts.Entities.TrustyDraftIssue", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint");
                    ...
                    b.Property<long>("DraftIssueTypeId")
                        .HasColumnType("bigint");
                    ...
                    b.Property<long?>("ReconsilationId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("DraftIssueTypeId");

                    b.HasIndex("IssueId");

                    b.HasIndex("ReconsilationId");

                    b.HasIndex("TrustyDraftId");

                    b.ToTable("TrustyDraftIssue", "TrustyDraft");
                });
            ...
            modelBuilder.Entity("SIMA.Domain.Models.Features.TrustyDrafts.WageRates.Entities.WageRate", b =>
                {
                    ...
                    b.Property<string>("IsBasedOnFixedValue")
                        .IsRequired()
                        .HasMaxLength(1)
                        .HasColumnType("nchar(1)")
                        .IsFixedLength();
            ...
            modelBuilder.Entity("SIMA.Domain.Models.Features.TrustyDrafts.TrustyDrafts.Entities.PaymentReceiptInfo", b =>
                {
                    b.HasOne("SIMA.Domain.Models.Features.BranchManagement.AccountTypes.Entities.AccountType", "BeneficiaryAccountType")
                        .WithMany("PaymentReceiptInfos")
                        .HasForeignKey("BeneficiaryAccountTypeId")
                        .IsRequired();
                    ...
                    b.Navigation("BeneficiaryAccountType");
            ...
            modelBuilder.Entity("SIMA.Domain.Models.Features.TrustyDrafts.TrustyDrafts.Entities.TrustyDraft", b =>
                {
                    ...
                    b.HasOne("SIMA.Domain.Models.Features.TrustyDrafts.DraftOrigins.Entities.CancellationResaon", "CancellationResaon")
                        .WithMany("TrustyDrafts")
                    ...
                    b.HasOne("SIMA.Domain.Models.Features.TrustyDrafts.DraftOrigins.Entities.ResponsibilityWageType", "ResponsibilityWageType")
                        .WithMany("TrustyDrafts")
            ...
            modelBuilder.Entity("SIMA.Domain.Models.Features.TrustyDrafts.TrustyDrafts.Entities.TrustyDraftIssue", b =>
                {
                    b.HasOne("SIMA.Domain.Models.Features.TrustyDrafts.DraftIssueTypes.Entities.DraftIssueType", "DraftIssueType")
                        .WithMany("TrustyDraftIssues")
                        .HasForeignKey("DraftIssueTypeId")
                        .IsRequired();
                    ...
                    b.HasOne("SIMA.Domain.Models.Features.TrustyDrafts.Reconsilations.Entities.Reconsilation", "Reconsilation")
                        .WithMany("TrustyDraftIssues")
                        .HasForeignKey("ReconsilationId");
                    ...
                    b.Navigation("DraftIssueType");

                    b.Navigation("Issue");

                    b.Navigation("Reconsilation");
            ...
            modelBuilder.Entity("SIMA.Domain.Models.Features.IssueManagement.Issues.Entities.Issue", b =>
                {
                    ...
                    b.Navigation("TrustyDraftIssues");
                });
