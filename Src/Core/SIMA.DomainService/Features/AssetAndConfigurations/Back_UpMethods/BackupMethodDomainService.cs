...
namespace SIMA.DomainService.Features.AssetAndConfigurations.Back_UpMethods;

public class BackupMethodDomainService : IBackupMethodDomainService
{
    private readonly SIMADBContext _context;

    public BackupMethodDomainService(SIMADBContext context)
    {
        _context = context;
    }
