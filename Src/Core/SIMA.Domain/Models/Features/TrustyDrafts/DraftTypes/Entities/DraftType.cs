...
namespace SIMA.Domain.Models.Features.TrustyDrafts.DraftTypes.Entities;

public class DraftType: Entity, IAggregateRoot
{
    private DraftType()
    {

    }
    private DraftType(CreateDraftTypeArg arg)
    {
        Id = new(arg.Id);
        Name = arg.Name;
        Code = arg.Code;
    ...
    public static async Task<DraftType> Create(CreateDraftTypeArg arg, IDraftTypeDomainService service)
    {
        await CreateGuards(arg, service);
        return new DraftType(arg);
    }
    #region Guards
    private static async Task CreateGuards(CreateDraftTypeArg arg, IDraftTypeDomainService service)
    {
        arg.NullCheck();
        arg.Name.NullCheck();
        arg.Code.NullCheck();
    ...
    private async Task ModifyGuards(ModifyDraftTypeArg arg, IDraftTypeDomainService service)
    {
        arg.NullCheck();
        arg.Name.NullCheck();
        arg.Code.NullCheck();
    ...
    #endregion
    public async Task Modify(ModifyDraftTypeArg arg, IDraftTypeDomainService service)
    {
    ...
    public DraftTypeId Id { get; private set; }
