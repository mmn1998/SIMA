...
namespace SIMA.Domain.Models.Features.BCP.ConsequenceIntensionDescriptions.Entities;

public class ConsequenceIntensionDescription : Entity, IAggregateRoot
{
    private ConsequenceIntensionDescription()
    {

    }
    private ConsequenceIntensionDescription(CreateConsequenceIntensionDescriptionArg arg)
    {
        Id = new(arg.Id);
    ...
    public static ConsequenceIntensionDescription Create(CreateConsequenceIntensionDescriptionArg arg)
    {
        CreateGuards(arg);
        return new ConsequenceIntensionDescription(arg);
    }
    public void Modify(ModifyConsequenceIntensionDescriptionArg arg)
    {
        ModifyGuards(arg);
    ...
    #region Guards
    private static void CreateGuards(CreateConsequenceIntensionDescriptionArg arg)
    {
        arg.NullCheck();
        arg.Name.NullCheck();
    ...
    private void ModifyGuards(ModifyConsequenceIntensionDescriptionArg arg)
    {
        arg.NullCheck();
        arg.Name.NullCheck();
    ...
    #endregion
    public ConsequenceIntensionDescriptionId Id { get; private set; }
