...
public class CriticalActivityServices : Entity
{
    private CriticalActivityServices() { }
    private CriticalActivityServices(CreateCriticalActivityServicesArg arg)
    {
    ...
    public static async Task<CriticalActivityServices> Create(CreateCriticalActivityServicesArg arg)
    {
        return new CriticalActivityServices(arg);
    }
