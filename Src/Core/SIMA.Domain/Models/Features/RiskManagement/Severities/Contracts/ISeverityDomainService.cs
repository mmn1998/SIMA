...
public interface ISeverityDomainService : IDomainService
{
    ...
    Task<bool> IsRelationsUnique(AffectedHistoryId AffectedHistoryId, ConsequenceLevelId ConsequenceLevelId, SeverityId? id = null);
    //Task<Severity?> IsSeverityValueExist(AffectedHistoryId AffectedHistoryId, ConsequenceLevelId ConsequenceLevelId);
}