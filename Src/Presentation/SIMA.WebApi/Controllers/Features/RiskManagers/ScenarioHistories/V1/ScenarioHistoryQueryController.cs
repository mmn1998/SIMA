...
public class ScenarioHistoryQueryController : ControllerBase
{
    private readonly IMediator _mediator;

    public ScenarioHistoryQueryController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    */
    ...
    {
        var query = new GetScenarioHistoryQuery { Id = id };
    ...
    */
    public async Task<Result> Get([FromBody] GetAllScenarioHistoryQuery query)
    {
        return await _mediator.Send(query);
    }
}