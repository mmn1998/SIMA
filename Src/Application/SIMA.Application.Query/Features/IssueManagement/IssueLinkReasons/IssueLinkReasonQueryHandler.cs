...
public class IssueLinkReasonQueryHandler :
     IQueryHandler<GetAllIssueLinkReasonsQuery, Result<IEnumerable<GetIssueLinkReasonQueryResult>>>,
     IQueryHandler<GetIssueLinkReasonQuery, Result<GetIssueLinkReasonQueryResult>>
{
    ...
    public async Task<Result<IEnumerable<GetIssueLinkReasonQueryResult>>> Handle(GetAllIssueLinkReasonsQuery request, CancellationToken cancellationToken)
    {
