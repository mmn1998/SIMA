...
{
    public class GetAssetCustomFieldQueryResult
    {
        ...
        public IEnumerable<GetAssetCustomFieldOption>? AssetCustomFieldOptionList { get; set; }
    }
}

public class GetAssetCustomFieldOption
{
