...
namespace SIMA.Application.Feaatures.RiskManagers.RiskLevels.Mapper
{
    public class RiskLevelMapper : Profile
    {
        public RiskLevelMapper(ISimaIdentity simaIdentity)
        {
            CreateMap<CreateRiskLevelCommand, CreateRiskLevelArgs>()
                .ForMember(dest => dest.ActiveStatusId, act => act.MapFrom(source => (long)ActiveStatusEnum.Active))
                //.ForMember(dest => dest.CreatedBy, act => act.MapFrom(source => simaIdentity.UserId))
                .ForMember(dest => dest.CreatedAt, act => act.MapFrom(source => DateTime.Now));

            CreateMap<ModifyRiskLevelCommand, ModifyRiskLevelArgs>()
                .ForMember(dest => dest.ActiveStatusId, act => act.MapFrom(source => (long)ActiveStatusEnum.Active))
