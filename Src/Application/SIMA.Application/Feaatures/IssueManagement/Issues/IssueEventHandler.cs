...
public class IssueEventHandler :
    ...
    INotificationHandler<ModifyRiskCreateEvents>,
    INotificationHandler<DeleteRiskCreateEvents>,
    ...
    INotificationHandler<CreateLogisticsSupplyEvent>,
    INotificationHandler<ModifyLogisticsSupplyEvent>,
    INotificationHandler<DeleteLogisticsSupplytEvent>,
    INotificationHandler<CreateServiceEvent>,
    INotificationHandler<ModifyServiceEvent>,
    INotificationHandler<DeleteServiceEvent>,
    INotificationHandler<CreateBusinessImpactAnalysisEvent>,
    INotificationHandler<ModifyBusinessImpactAnalysisEvent>,
    INotificationHandler<DeleteBusinessImpactAnalysisEvent>,
    INotificationHandler<CreateBusinessContinuityStrategyEvent>,
    ...
    INotificationHandler<WorkflowModifiedEvent>

{
    ...
    public async Task Handle(MeetingCreatedEvent notification, CancellationToken cancellationToken)
    {
        try
        {
            ...
            arg.IssuePriorityId = issuePriorityId;// 7678559058;
            arg.IssueTypeId = issueTypeId;// 4131511500;
    ...
    public async Task Handle(CreateLogisticsRequestEvent notification, CancellationToken cancellationToken)
    {
        try
        {
            ...
            if (notification.RequesterId.HasValue)
                arg.RequesterId = notification.RequesterId.Value;
    ...
    public async Task Handle(ModifyLogisticsRequestEvent notification, CancellationToken cancellationToken)
    {
        ...
        var IssueWeightCategoryd = await _issueWeightCategoryRepository.GetIdByWeight((int)notification.weight);
        if (IssueWeightCategoryd != 0)
        {
            arg.IssueWeightCategoryd = IssueWeightCategoryd;
        }
    ...
    public async Task Handle(ModifyServiceEvent notification, CancellationToken cancellationToken)
    {
        ...
        arg.IssueTypeId = entity.IssueTypeId.Value;
        arg.IssuePriorityId = entity.IssuePriorityId.Value;
        #region history
        var historyArg = _mapper.Map<CreateIssueChangeHistoryArg>(arg);
        await entity.Modify(arg, _service);
        historyArg.CreatedBy = _simaIdentity.UserId;
    ...
    public async Task Handle(CreateLogisticsSupplyEvent notification, CancellationToken cancellationToken)
    {
        try
        {
            var workFlowEnity = await _workFlowRepository.GetWorkFlowByAggregateId(notification.MainAggregateType);
            ...
            arg.CurrentWorkflowId = workflow.Id;
            arg.IssueTypeId = issueTypeId;
            if (notification.RequesterId.HasValue && notification.RequesterId != 0)
            {
                arg.RequesterId = notification.RequesterId.Value;
            }
            if (notification.IssuePriority > 0)
    ...
    public async Task Handle(ModifyLogisticsSupplyEvent notification, CancellationToken cancellationToken)
    {
        var entity = await _repository.GetById(notification.issueId);
        var arg = _mapper.Map<ModifyIssueArg>(notification);
        arg.Id = entity.Id.Value;
        ...
        if (notification.RequesterId.HasValue && notification.RequesterId != 0)
        {
            arg.RequesterId = notification.RequesterId;
        }
        #region history
        var historyArg = _mapper.Map<CreateIssueChangeHistoryArg>(arg);
        await entity.Modify(arg, _service);
    ...
    public async Task Handle(DeleteLogisticsSupplytEvent notification, CancellationToken cancellationToken)
    {
        var entity = await _repository.GetById(notification.issueId);
        long userId = _simaIdentity.UserId;
        entity.Delete(userId);
    }
    public async Task Handle(DeleteRiskCreateEvents notification, CancellationToken cancellationToken)
    {
        var entity = await _repository.GetById(notification.issueId);
        long userId = _simaIdentity.UserId;
        entity.Delete(userId);
    }
    public async Task Handle(ModifyRiskCreateEvents notification, CancellationToken cancellationToken)
    {
        var entity = await _repository.GetById(notification.issueId);
        var arg = _mapper.Map<ModifyIssueArg>(notification);
        arg.Id = entity.Id.Value;
    ...
    public async Task Handle(CreateBusinessImpactAnalysisEvent notification, CancellationToken cancellationToken)
    {
        var workFlowEnity = await _workFlowRepository.GetWorkFlowByAggregateId(notification.mainAggregateType);
    ...
    public async Task Handle(ModifyBusinessImpactAnalysisEvent notification, CancellationToken cancellationToken)
    {
        var entity = await _repository.GetById(notification.issueId);
        var arg = _mapper.Map<ModifyIssueArg>(notification);
        arg.Id = entity.Id.Value;
    ...
    public async Task Handle(DeleteBusinessImpactAnalysisEvent notification, CancellationToken cancellationToken)
    {
        var entity = await _repository.GetById(notification.issueId);
        long userId = _simaIdentity.UserId;
        entity.Delete(userId);
    ...
    public async Task Handle(CreateBusinessContinuityPlanEvent notification, CancellationToken cancellationToken)
    {
        var workFlowEnity = await _workFlowRepository.GetWorkFlowByAggregateId(notification.MainAggregateType);
    ...
    public async Task Handle(CreateBusinessContinuityStrategyEvent notification, CancellationToken cancellationToken)
    {
        var workFlowEnity = await _workFlowRepository.GetWorkFlowByAggregateId(notification.mainAggregateType);
    ...
    public async Task Handle(ModifyBusinessContinuityStrategyEvent notification, CancellationToken cancellationToken)
    {
        var entity = await _repository.GetById(notification.issueId);
        var arg = _mapper.Map<ModifyIssueArg>(notification);
        arg.Id = entity.Id.Value;
    ...
    public async Task Handle(DeleteBusinessContinuityStrategyEvent notification, CancellationToken cancellationToken)
    {
        var entity = await _repository.GetById(notification.issueId);
        long userId = _simaIdentity.UserId;
        entity.Delete(userId);
    }
    public async Task Handle(CreateTrustyDraftEvent notification, CancellationToken cancellationToken)
    {
        try
        {
            var workFlowEnity = await _workFlowRepository.GetWorkFlowByAggregateId(notification.MainAggregateType);
    ...
    public async Task Handle(ModifyTrustyDraftEvent notification, CancellationToken cancellationToken)
    {
        var entity = await _repository.GetById(notification.issueId);
        var arg = _mapper.Map<ModifyIssueArg>(notification);
        arg.Id = entity.Id.Value;
    ...
    public async Task Handle(WorkflowModifiedEvent notification, CancellationToken cancellationToken)
    {
        var issues = await _repository.GetByStepIds(notification.DeactiveStepIds);
