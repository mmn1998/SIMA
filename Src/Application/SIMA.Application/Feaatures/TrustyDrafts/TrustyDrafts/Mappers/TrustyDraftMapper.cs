...
public class TrustyDraftMapper : Profile
{
    public TrustyDraftMapper()
    {
        ...
        CreateMap<GetTrustCurrencyDraftMansha, CreateTrustyDraftArg>()
           ...
           .ForMember(dest => dest.DraftNetAmount, act => act.MapFrom(source => source.Data[0].settelmentAmnt))
           ...
           .ForMember(dest => dest.DraftRequestNetAmountBasedOnUsd, act => act.MapFrom(source => source.Data[0].bSettelmentAmnt))
