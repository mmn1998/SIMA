...
using SIMA.Application.Feaatures.RiskManagers.CobitScenarios.Mappers;
...
using SIMA.Application.Feaatures.RiskManagers.CurrentOccurrenceProbabilityValues.Mappers;
using SIMA.Application.Feaatures.RiskManagers.EvaluationCriterias.Mappers;
using SIMA.Application.Feaatures.RiskManagers.Frequencies.Mapper;
...
using SIMA.Application.Feaatures.TrustyDrafts.DraftStatuses.Mappers;
...
using SIMA.Application.Feaatures.TrustyDrafts.ReconsilationTypes.Mappers;
       ...
       return services.AddAutoMapper((serviceProvider, conf) =>
        {
            using (var scope = serviceProvider.CreateScope())
            {
                ...
                conf.AddProfile(new CobitScenarioMapper());
